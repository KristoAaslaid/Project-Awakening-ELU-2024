...
NMilitary = {
	...
	STRATEGIC_SPEED_INFRA_BASE = 700.0,               -- Base speed of strategic redeployment when not on railways
	STRATEGIC_SPEED_INFRA_MAX = 800.0,               -- Additional speed of strategic redeployment on max-level infrastructure
	STRATEGIC_SPEED_RAIL_BASE = 800.0,               -- Base speed of strategic redeployment when on railways
	STRATEGIC_SPEED_RAIL_MAX = 900.0,                -- Additional speed of strategic redeployment on max-level railways
...
NNavy = {
	...
	NAVAL_SPEED_MODIFIER = 5.0,	                    				-- basic speed control
	...
	MINIMUM_SHIP_SPEED = 10.0,										-- slowest speed a ship can have
